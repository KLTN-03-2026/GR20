...
export default function ScanQrPage() {
  ...
  return (
    <div className="bg-surface text-on-surface min-h-screen font-['Inter',sans-serif]">
      ...
      <div className='flex flex-col min-h-screen'>
        {/* Header */}
        <div className='border-b border-outline/20 bg-surface-container-low'>
          <div className='max-w-7xl mx-auto px-4 md:px-6 py-6'>
            <div className='flex items-center gap-3'>
              <div className='w-12 h-12 bg-gradient-to-br from-primary to-primary-container rounded-xl flex items-center justify-center shadow-md'>
                <span className='material-symbols-outlined text-2xl text-white'>qr_code</span>
              </div>
              <div>
                <h1 className='text-2xl md:text-3xl font-bold text-primary'>Quét QR</h1>
                <p className='text-outline text-sm'>Homelink Scanner</p>
              </div>
            </div>
          </div>
        </div>
