// // src/pages/Resident/GuestQRDetail.tsx
...
//     queryFn: () => QRCodeApi.getHistoryQrKhachId(id)
//   })

//   const totalElements = dataHistory?.data.data || 0
...
//   //   try {
//   //     const res = await QRCodeApi.getHistoryQrKhachId(id, {
//   //       page: historyPage,
//   //       limit: showAllHistory ? 100 : 5,
//   //     })
...
//   const isUsedUp = guestQR?.used_entries >= guestQR?.max_entries
...
//               <nav className='flex items-center text-xs text-on-surface-variant font-medium uppercase tracking-[0.05em] mb-2'>
//                 <span className='hover:text-primary cursor-pointer transition-colors'>Quản lý QR</span>
//                 <span className='material-symbols-outlined text-[14px] mx-2'>chevron_right</span>
//                 <span className='text-primary'>Chi tiết mã QR Khách</span>
//               </nav>
...
//                         {showAllHistory ? totalElements : 10}/{totalElements}
//                       </span>
//                     )}
//                   </div>
//                   {totalElements > 10 && (
...
//                       className='text-xs font-bold text-primary uppercase tracking-widest hover:underline transition-all'
//                     >
//                       {showAllHistory ? 'Thu gọn' : `Xem tất cả (${totalElements})`}
//                     </button>
//                   )}
//                 </div>
//                 <div className='divide-y divide-outline-variant/5 max-h-96 overflow-y-auto'>
...
//                         )
//                       })}
//                       {/* Loader khi đang load page 2 */}
//                       {/* {showAllHistory && isLoadingPage2 && (
//                         <div className='flex justify-center py-8'>
//                           <div className='animate-spin rounded-full h-6 w-6 border-b-2 border-primary'></div>
//                           <span className='ml-2 text-xs text-on-surface-variant'>Đang tải thêm...</span>
//                         </div>
//                       )} */}
//                     </>
//                   )}
...
//   // Query page 1 của lịch sử
//   const { data: dataHistoryPage1, isLoading: isHistoryLoadingPage1 } = useQuery({
//     queryKey: [`guest-qrs/${id}/history`, 1],
//     queryFn: () => QRCodeApi.getHistoryQrKhachId(id),
//     enabled: !!id
//   })

//   // Query page 2 của lịch sử (chỉ chạy khi showAllHistory = true)
//   const { data: dataHistoryPage2, isLoading: isHistoryLoadingPage2 } = useQuery({
//     queryKey: [`guest-qrs/${id}/history`, 2],
//     queryFn: () => QRCodeApi.getHistoryQrKhachId(id),
//     enabled: !!id && showAllHistory
//   })

//   const guestQR = data?.data?.data

//   // Gộp lịch sử từ page 1 và page 2
//   useEffect(() => {
//     if (dataHistoryPage1?.data) {
//       const page1Data = dataHistoryPage1.data.data || []
//       if (showAllHistory && dataHistoryPage2?.data) {
//         const page2Data = dataHistoryPage2.data.data || []
//         setAllHistoryData([...page1Data, ...page2Data])
//       } else {
//         setAllHistoryData(page1Data)
//       }
//     }
//   }, [dataHistoryPage1, dataHistoryPage2, showAllHistory])

//   // Tổng số bản ghi và số trang
//   const totalElements = dataHistoryPage1?.data?.totalElements || 0
//   const totalPages = dataHistoryPage1?.data?.totalPages || 1
//   const hasMorePages = totalPages > 1
//   const isHistoryLoading = isHistoryLoadingPage1 || (showAllHistory && isHistoryLoadingPage2)
...
//                     {totalElements > 0 && (
//                       <span className='text-xs text-on-surface-variant bg-surface-container-high px-2 py-0.5 rounded-full'>
//                         {showAllHistory ? totalElements : Math.min(10, totalElements)} / {totalElements}
//                       </span>
//                     )}
//                   </div>
//                   {hasMorePages && !showAllHistory && (
//                     <button
...
//                         )
//                       })}
//                       {/* Hiển thị loader khi đang load page 2 */}
//                       {showAllHistory && isHistoryLoadingPage2 && (
//                         <div className='flex justify-center py-8'>
//                           <div className='animate-spin rounded-full h-6 w-6 border-b-2 border-primary'></div>
//                           <span className='ml-2 text-xs text-on-surface-variant'>Đang tải thêm...</span>
//                         </div>
